...
public class TSBHashtableDA<K,V> implements Map<K,V>, Cloneable, Serializable
{
    ...
    public V get(Object key) 
    {
        ...
        V valor = null;
        int ik = h(k);
        Map.Entry<K, V> x = search_for_entry(k, ik);
        if(x != null)
        {
    ...
    public boolean contains(Object value)
    {
        ...
        {
            Entry<K, V> entry = (Entry<K,V>) c;
            if(entry.getState() == CLOSED && value.equals(entry.getValue())){
                return true;
            }
        }
    ...
    private class KeySet extends AbstractSet<K> 
    {
        ...
        private class KeySetIterator implements Iterator<K>
        {
            ...
            public boolean hasNext() 
            {
                ...
                Entry<K, V> x = (Entry<K, V>) t[next_bucket];
                if(x.state == TOMBSTONE || x.state == OPEN){

                    while(((Entry<K,V>)t[next_bucket]).state == TOMBSTONE || ((Entry<K,V>)t[next_bucket]).state == OPEN){
                        next_bucket++;
                        if(next_bucket >= t.length) { return false; }
            ...
            public K next() 
            {
                ...
                Entry<K, V> x = (Entry<K, V>) t[current_bucket];

                while(x.state == TOMBSTONE || x.state == OPEN){
                    current_bucket++;
                    x = (Entry<K, V>) t[current_bucket];
                }
            ...
            public void remove() 
            {
                ...
                Object t[] = TSBHashtableDA.this.table;
                Entry <K, V> garbage = (Entry<K, V>) t[current_bucket];

                garbage.setState(TOMBSTONE);
    ...
    private class EntrySet extends AbstractSet<Map.Entry<K, V>> 
    {
        ...
        public boolean contains(Object o) 
        {
            ...
            if (search_for_index(key, ik) != -1) { return true; }
            return false;
        }
        ...
        private class EntrySetIterator implements Iterator<Map.Entry<K, V>>
        {
            ...
            public Map.Entry<K, V> next() 
            {
                ...
                // y retornar el elemento alcanzado...
                return (Entry<K, V>) t[current_bucket];
            }
            ...
            public void remove() 
            {
                ...
                Object t[] = TSBHashtableDA.this.table;
                Entry<K, V> garbaje = (Entry<K, V>) t[current_bucket];

                garbaje.setState(TOMBSTONE);
